...
//
//    }
        public static String getID(IDBo paramBo) throws Exception {
        ...
        Map<String, String> querys = new HashMap<String, String>();
        Map<String, String> bodys = new HashMap<String, String>();
        bodys.put("cardNo", paramBo.getCardNo());
        bodys.put("realName", paramBo.getRealName());
